...
protected:
    ...
    int x, y;
public:
    Shape(int x, int y, bool isFilled, std::string& color, bool colorFramed, std::string& color2) : x(x), y(y), isFilled(isFilled), color(color), colorFramed(colorFramed), color2(color2) {};
